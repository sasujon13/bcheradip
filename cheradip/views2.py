...
from .models import Institutes, Token, Item, Merit, Merit5, Banbeis, Recommend, Vacancy6, Vacancy5, Customer, Order, OrderDetail, Transaction, Ordered, Canceled, Notification
from .serializers import InstitutesSerializer, TokenSerializer, RecommendSerializer, BanbeisSerializer, MeritSerializer, Merit5Serializer, VacancySerializer, Vacancy5Serializer, ItemSerializer, CustomerSerializer, CustomerUpdateSerializer, OrderSerializer, NotificationSerializer
...
class InstitutesViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        divisionName = self.request.query_params.get('divisionName')
...
class NotificationExistsView(APIView):
    def get(self, request, *args, **kwargs):

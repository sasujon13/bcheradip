...
class Vacancy6(models.Model):
    VPID = models.BigIntegerField(primary_key=True)  # Primary Key
...
class Merit(models.Model):
    Code = models.BigIntegerField(max_length=3)
    Name = models.CharField(max_length=255)
    Batch = models.BigIntegerField(max_length=2)
    Roll = models.BigIntegerField(max_length=15)
    Mark = models.BigIntegerField(max_length=3)
    Rank = models.BigIntegerField(max_length=7)
    SL = models.BigIntegerField(max_length=7)
    Subject = models.CharField(max_length=127)

    def __str__(self):
        return f"{self.Batch} {self.Roll} {self.Mark}"
...
class Banbeis(models.Model):
    ...
    def __str__(self):
        return f"EIIN: {self.EIIN} | InstituteType: {self.InstituteType}"
...
class Token(models.Model):
    ...
    def __str__(self):
        return f"Token: {self.Token} | Counter: {self.Counter}"
...
class Institutes(models.Model):
    ...
    def __str__(self):
        return f"{self.eiinNo} - {self.instituteName}"
